...
{
    public class ListBoreholeStandardConfiguration : IEntityTypeConfiguration<ListBoreholeStandard>
    {
        public void Configure(EntityTypeBuilder<ListBoreholeStandard> builder)
        {
            builder.ToTable("list_borehole_standard", "ref");
