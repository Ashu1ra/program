...
{
    public class ListBoreholeTypeConfiguration : IEntityTypeConfiguration<ListBoreholeType>
    {
        public void Configure(EntityTypeBuilder<ListBoreholeType> builder)
        {
            builder.ToTable("list_borehole_type", "ref");
