...
{
    public class ListFileFormatConfiguration : IEntityTypeConfiguration<ListFileFormat>
    {
        public void Configure(EntityTypeBuilder<ListFileFormat> builder)
        {
            builder.ToTable("list_file_format", "ref");
